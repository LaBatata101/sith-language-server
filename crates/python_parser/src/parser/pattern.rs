...
use python_ast::{self as ast, ContextExpr, Expr, Number, Operator, Pattern, Singleton};
            ...
            if parser.eat(TokenKind::DoubleStar) {
                ...
                let key = match parser.parse_match_pattern_lhs(AllowStarPattern::No) {
                    ...
                    Pattern::MatchSingleton(ast::PatternMatchSingleton { value, range }) => {
                        match value {
                            Singleton::None => Expr::NoneLiteral(ast::NoneLiteralExpr { range }),
                            Singleton::True => {
        ...
        match self.current_token_kind() {
            ...
            kind => {
                ...
                if self.at_name_or_keyword() {
                    ...
                    let invalid_node = Expr::Name(ast::NameExpr {
